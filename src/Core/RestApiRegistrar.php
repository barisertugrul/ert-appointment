...
final class RestApiRegistrar
{
    ...
    private function registerAvailabilityRoutes(): void
    {
        ...
        register_rest_route('erta/v1', '/providers/(?P<id>\d+)/slots', [
            'methods'             => 'GET',
        ...
        register_rest_route('erta/v1', '/providers/(?P<id>\d+)/calendar', [
            'methods'             => 'GET',
            ...
            'args'                => [
                ...
                'to'   => ['required' => true, 'type' => 'string', 'format' => 'date'],
            ],
        ]);
    }
    ...
    private function registerAppointmentRoutes(): void
    {
        ...
        register_rest_route('erta/v1', '/appointments', [
            'methods'             => 'POST',
        ...
        register_rest_route('erta/v1', '/appointments/(?P<id>\d+)', [
            'methods'             => 'GET',
            'callback'            => fn($req) => $ctrl()->get($req),
            'permission_callback' => fn($req) => $ctrl()->canViewAppointment($req),
        ]);

        // PUT /erta/v1/appointments/{id}/confirm
        register_rest_route('erta/v1', '/appointments/(?P<id>\d+)/confirm', [
            'methods'             => 'PUT',
            'callback'            => fn($req) => $ctrl()->confirm($req),
            'permission_callback' => fn($req) => $ctrl()->canManageAppointment($req),
        ]);

        // PUT /erta/v1/appointments/{id}/cancel
        register_rest_route('erta/v1', '/appointments/(?P<id>\d+)/cancel', [
            'methods'             => 'PUT',
            'callback'            => fn($req) => $ctrl()->cancel($req),
            'permission_callback' => fn($req) => $ctrl()->canActOnAppointment($req),
        ]);

        // PUT /erta/v1/appointments/{id}/reschedule
        register_rest_route('erta/v1', '/appointments/(?P<id>\d+)/reschedule', [
            'methods'             => 'PUT',
        ...
        register_rest_route('erta/v1', '/my-appointments', [
            'methods'             => 'GET',
        ...
        register_rest_route('erta/v1', '/admin/appointments', [
            'methods'             => 'GET',
        ...
        register_rest_route('erta/v1', '/provider/appointments', [
            'methods'             => 'GET',
    ...
    private function registerFormRoutes(): void
    {
        ...
        register_rest_route('erta/v1', '/forms/(?P<scope>[a-z]+)(?:/(?P<scope_id>\d+))?', [
            'methods'             => 'GET',
            'callback'            => fn($req) => $ctrl()->get($req),
            'permission_callback' => '__return_true',
        ]);
    ...
    private function registerDepartmentRoutes(): void
    {
        ...
        register_rest_route('erta/v1', '/departments', [
            'methods'             => 'GET',
    ...
    private function registerProviderRoutes(): void
    {
        ...
        register_rest_route('erta/v1', '/providers', [
            'methods'             => 'GET',
            'callback'            => fn($req) => $ctrl()->index($req),
            'permission_callback' => '__return_true',
        ]);
        ...
        register_rest_route('erta/v1', '/providers/(?P<id>\d+)', [
            'methods'             => 'GET',
            'callback'            => fn($req) => $ctrl()->get($req),
            'permission_callback' => '__return_true',
        ]);
    ...
    private function registerAdminSettingsRoutes(): void
    {
        ...
        register_rest_route('erta/v1', '/admin/settings', [
            [
                'methods'             => 'GET',
                'callback'            => fn($req) => $ctrl()->get($req),
    ...
    private function registerAdminDepartmentRoutes(): void
    {
        ...
        register_rest_route('erta/v1', '/admin/departments', [
            [
                'methods'             => 'GET',
                'callback'            => fn($req) => $ctrl()->index($req),
                'permission_callback' => $admin,
        ...
        register_rest_route('erta/v1', '/admin/departments/(?P<id>\d+)', [
            [
                'methods'             => 'PUT',
    ...
    private function registerAdminProviderRoutes(): void
    {
        ...
        register_rest_route('erta/v1', '/admin/providers', [
            [
                'methods'             => 'GET',
                'callback'            => fn($req) => $ctrl()->index($req),
                'permission_callback' => $admin,
        ...
        register_rest_route('erta/v1', '/admin/providers/(?P<id>\d+)', [
            [
                'methods'             => 'PUT',
                'callback'            => fn($req) => $ctrl()->update($req),
                'permission_callback' => $admin,
        ...
        register_rest_route('erta/v1', '/admin/providers/(?P<id>\d+)/users', [
            [
                'methods'             => 'GET',
        ...
        register_rest_route('erta/v1', '/admin/providers/(?P<id>\d+)/users/(?P<user_id>\d+)', [
            'methods'             => 'DELETE',
    ...
    private function registerAdminFormRoutes(): void
    {
        ...
        register_rest_route('erta/v1', '/admin/forms', [
            [
                'methods'             => 'GET',
                'callback'            => fn($req) => $ctrl()->index($req),
                'permission_callback' => $admin,
        ...
        register_rest_route('erta/v1', '/admin/forms/(?P<id>\d+)', [
            [
                'methods'             => 'PUT',
                'callback'            => fn($req) => $ctrl()->update($req),
                'permission_callback' => $admin,
    ...
    private function registerAdminNotificationRoutes(): void
    {
        ...
        register_rest_route('erta/v1', '/admin/notification-templates/placeholders', [
            'methods'             => 'GET',
            'callback'            => fn($req) => $ctrl()->placeholders($req),
            'permission_callback' => $admin,
        ]);

        register_rest_route('erta/v1', '/admin/notification-templates', [
            [
                'methods'             => 'GET',
                'callback'            => fn($req) => $ctrl()->index($req),
                'permission_callback' => $admin,
        ...
        register_rest_route('erta/v1', '/admin/notification-templates/(?P<id>\d+)', [
            [
                'methods'             => 'GET',
                'callback'            => fn($req) => $ctrl()->get($req),
                'permission_callback' => $admin,
